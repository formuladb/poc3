BEGIN;
    ...
    SELECT col_type_is( current_schema(), 'dst_tbl', 'src_id', 'pg_catalog', 'integer', 'check-type' );
    SELECT col_type_is( current_schema(), 'dst_tbl', 'dst_nb', 'pg_catalog', 'integer', 'check-type' );
