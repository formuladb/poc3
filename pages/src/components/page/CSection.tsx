...
export const CSectionCOVER = (nP: CSectionCOVERProps) => {
    return <>
...
export const CSectionHEADER = (nP: CSectionHEADERProps) => {
    return <>
...
export const CSectionMEDIA = (nP: CSectionMEDIAProps) => {
    return <>
...
export const CSectionCARDS = (nP: CSectionCARDSProps) => {
    return <>
...
export const CSectionCARDS2 = (nP: CSectionCARDS2Props) => {
    return <>
