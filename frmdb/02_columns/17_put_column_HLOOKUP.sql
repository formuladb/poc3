...
BEGIN
    ...
    BEGIN
        RAISE NOTICE '% HLOOKUP_src_s: %', v_in, TG_ARGV;
        ...
        ELSE -- TG_OP = 'UPDATE' OR TG_OP = 'INSERT' THEN
            ...
            LOOP
                ...
                EXECUTE v_stm;
                RAISE NOTICE '% HLOOKUP_src_s: %.% = %.', v_in, v_dst_table_name, v_dst_col_name, v_rec.src_col_value;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '% HLOOKUP_dst_r: %', v_in, TG_ARGV;
        ...
        ELSE --(TG_OP = 'UPDATE' OR TG_OP = 'INSERT') THEN
            ...
            RAISE NOTICE '% HLOOKUP_dst_r: %.% = % (%.% = %).', v_in, v_src_table_name, v_src_col_name, v_src_rec.src_col_value, v_dst_table_name, v_dst_ref_col_name, v_dst_h->v_dst_ref_col_name;
